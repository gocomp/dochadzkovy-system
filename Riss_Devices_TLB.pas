...
uses Windows, ActiveX, Classes, Graphics, mscoree_TLB, mscorlib_TLB, OleServer,
  StdVCL,
...
const
  ...
  CLASS_Zd2911DeviceConnection
    : TGUID = '{8700A266-9300-43AA-8FCE-2A25EE51BAED}';
  IID__Zd2911EnrollFileManagement
    : TGUID = '{787A0B63-5843-3E76-AEE9-A2B7D8F4314E}';
  ...
  CLASS_Zd2911EnrollFileManagement
    : TGUID = '{1E9F786B-2C78-37C8-8FD2-0FA1D0298404}';
...
type
  ...
  IZd2911EnrollFile = interface(IDispatch)
    ...
    function SaveAllUserExtEnrollDataAsDB(const fileName: WideString;
      var userExts: PSafeArray): WordBool; safecall;
    function SaveUserExtEnrollDataAsDB(const fileName: WideString;
      var UserExt: IUserExt): WordBool; safecall;
    function LoadAllUserExtEnrollDataFromDB(const fileName: WideString;
      var userExts: PSafeArray): WordBool; safecall;
    function LoadUserExtEnrollDataFromDB(const fileName: WideString;
      var UserExt: IUserExt): WordBool; safecall;
    function SaveUserExtNameData(const fileName: WideString;
      var userExts: PSafeArray): WordBool; safecall;
    function LoadUserExtNameData(const fileName: WideString;
      var userExts: PSafeArray): WordBool; safecall;
  end;
  ...
  IZd2911EnrollFileDisp = dispinterface
    ...
    function SaveUserExtEnrollDataAsDB(const fileName: WideString;
      var UserExt: IUserExt): WordBool; dispid 2;
    function LoadAllUserExtEnrollDataFromDB(const fileName: WideString;
      var userExts: { ??PSafeArray } OleVariant): WordBool; dispid 3;
    function LoadUserExtEnrollDataFromDB(const fileName: WideString;
      var UserExt: IUserExt): WordBool; dispid 4;
    function SaveUserExtNameData(const fileName: WideString;
      var userExts: { ??PSafeArray } OleVariant): WordBool; dispid 5;
    function LoadUserExtNameData(const fileName: WideString;
      var userExts: { ??PSafeArray } OleVariant): WordBool; dispid 6;
  end;
  ...
  IZd2911Listener = interface(IDispatch)
    ...
    procedure remove_ReceiveHandlerExt(const value
      : _ReceiveHandlerExt); safecall;
  ...
  IUserExt = interface(IDispatch)
    ...
    property AccessControl: Integer read Get_AccessControl
      write Set_AccessControl;
    property ValidityPeriod: WordBool read Get_ValidityPeriod
      write Set_ValidityPeriod;
    property UseUserGroupACTZ: WordBool read Get_UseUserGroupACTZ
      write Set_UseUserGroupACTZ;
    property UseUserGroupVM: WordBool read Get_UseUserGroupVM
      write Set_UseUserGroupVM;
    ...
    property AccessTimeZone: Integer read Get_AccessTimeZone
      write Set_AccessTimeZone;
  ...
  IMonitor = interface(IDispatch)
    ...
    property SerialBaudRate: Integer read Get_SerialBaudRate
      write Set_SerialBaudRate;
  end;
  ...
  IEnrollExtDisp = dispinterface
    ...
    procedure SetFingerprint(var Fingerprint
      : { ??PSafeArray } OleVariant); dispid 7;
  end;
  ...
  IZd2911Tools = interface(IDispatch)
    ...
    function CreateChunkHeader(var buffer: PSafeArray; dataChunk: Integer)
      : PSafeArray; safecall;
    ...
    function GetUserExtWithoutEnroll(var buffer: PSafeArray): IUserExt;
      safecall;
    function GetAllUserExtWithoutEnroll(var buffer: PSafeArray)
      : PSafeArray; safecall;
    ...
    function GetASCII(var bs: PSafeArray; index: Integer; length: Integer)
      : WideString; safecall;
    function GetStringByNum(var bs: PSafeArray; index: Integer;
      type_: NumberType): WideString; safecall;
    function GetBytesByNum(const input: WideString; type_: NumberType)
      : PSafeArray; safecall;
    function ConvertIPAddressToNumber(const strIPAddress: WideString)
      : Integer; safecall;
    function ConvertNumberToIPAddress(intIPAddress: Integer)
      : WideString; safecall;
    function ConvertFingerprintToString(var Fingerprint: PSafeArray)
      : WideString; safecall;
    function ConvertStringFingerprintToBytes(const Fingerprint: WideString)
      : PSafeArray; safecall;
  ...
  IZd2911ToolsDisp = dispinterface
    ...
    function CreateChunkHeader(var buffer: { ??PSafeArray } OleVariant;
      dataChunk: Integer): { ??PSafeArray } OleVariant; dispid 3;
    function GetSLogList(var buffer: { ??PSafeArray } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 4;
    function GetUserExtWithoutEnroll(var buffer: { ??PSafeArray } OleVariant)
      : IUserExt; dispid 5;
    function GetAllUserExtWithoutEnroll(var buffer: { ??PSafeArray } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 6;
    function GetGLogList(var buffer: { ??PSafeArray } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 7;
    function GetBytes(const input: WideString)
      : { ??PSafeArray } OleVariant; dispid 8;
    function GetString(var bs: { ??PSafeArray } OleVariant)
      : WideString; dispid 9;
    function GetASCII(var bs: { ??PSafeArray } OleVariant; index: Integer;
      length: Integer): WideString; dispid 10;
    function GetStringByNum(var bs: { ??PSafeArray } OleVariant; index: Integer;
      type_: NumberType): WideString; dispid 11;
    function GetBytesByNum(const input: WideString; type_: NumberType)
      : { ??PSafeArray } OleVariant; dispid 12;
    ...
    function ConvertNumberToIPAddress(intIPAddress: Integer): WideString;
      dispid 14;
    function ConvertFingerprintToString(var Fingerprint
      : { ??PSafeArray } OleVariant): WideString; dispid 15;
    function ConvertStringFingerprintToBytes(const Fingerprint: WideString)
      : { ??PSafeArray } OleVariant; dispid 16;
  ...
  IDevice = interface(IDispatch)
    ...
    property ConnectionModel: Integer read Get_ConnectionModel
      write Set_ConnectionModel;
  end;
  ...
  IZd2911DeviceConnection = interface(IDispatch)
    ...
    function SetPropertyExt(property_: UserProperty;
      var extraProperty: PSafeArray; const User: IUserExt;
      var extraData: PSafeArray): WordBool; safecall;
    function GetPropertyExt(property_: UserProperty;
      var extraProperty: PSafeArray; var User: IUserExt;
      var extraData: PSafeArray): WordBool; safecall;
    function SetPropertyExt_2(property_: DeviceProperty;
      var extraProperty: PSafeArray; const Device: IDevice;
      var extraData: PSafeArray): WordBool; safecall;
    function GetPropertyExt_2(property_: DeviceProperty;
      var extraProperty: PSafeArray; var Device: IDevice;
      var extraData: PSafeArray): WordBool; safecall;
  end;
  ...
  IZd2911DeviceConnectionDisp = dispinterface
    ...
    function SetPropertyExt(property_: UserProperty;
      var extraProperty: { ??PSafeArray } OleVariant; const User: IUserExt;
      var extraData: { ??PSafeArray } OleVariant): WordBool; dispid 3;
    function GetPropertyExt(property_: UserProperty;
      var extraProperty: { ??PSafeArray } OleVariant; var User: IUserExt;
      var extraData: { ??PSafeArray } OleVariant): WordBool; dispid 4;
    function SetPropertyExt_2(property_: DeviceProperty;
...
{$ENDIF}
  ...
  public
    ...
    procedure Disconnect; override;
    property DefaultInterface: _Zd2911EnrollFileManagement
      read GetDefaultInterface;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TZd2911EnrollFileManagementProperties
...
class function CoZd2911EnrollFile.CreateRemote(const MachineName: string)
  : IZd2911EnrollFile;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911EnrollFile)
    as IZd2911EnrollFile;
end;

procedure TZd2911EnrollFile.InitServerData;
const
  CServerData: TServerData = (ClassID: '{3BE9683B-9E12-4159-A5FB-A80790FCAB43}';
    IntfIID: '{E21860DC-55D6-42DF-A999-DC4FB3EE959D}'; EventIID: '';
...
function TZd2911EnrollFile.SaveAllUserExtEnrollDataAsDB(const fileName
  : WideString; var userExts: PSafeArray): WordBool;
begin
...
function TZd2911EnrollFile.LoadAllUserExtEnrollDataFromDB(const fileName
  : WideString; var userExts: PSafeArray): WordBool;
begin
  Result := DefaultInterface.LoadAllUserExtEnrollDataFromDB(fileName, userExts);
end;

function TZd2911EnrollFile.LoadUserExtEnrollDataFromDB(const fileName
  : WideString; var UserExt: IUserExt): WordBool;
begin
  Result := DefaultInterface.LoadUserExtEnrollDataFromDB(fileName, UserExt);
end;

function TZd2911EnrollFile.SaveUserExtNameData(const fileName: WideString;
  var userExts: PSafeArray): WordBool;
begin
  Result := DefaultInterface.SaveUserExtNameData(fileName, userExts);
end;

function TZd2911EnrollFile.LoadUserExtNameData(const fileName: WideString;
  var userExts: PSafeArray): WordBool;
begin
...
class function CoZd2911Tools.CreateRemote(const MachineName: string)
  : IZd2911Tools;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911Tools)
    as IZd2911Tools;
end;

procedure TZd2911Tools.InitServerData;
const
  CServerData: TServerData = (ClassID: '{5FCCCFAE-27BC-4A1D-BB6E-5558ECD42D30}';
    IntfIID: '{9CD049BD-DE2D-49DD-A1BD-F2BCFB4E4C3E}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
function TZd2911Tools.CreateChunkHeader(var buffer: PSafeArray;
  dataChunk: Integer): PSafeArray;
begin
...
function TZd2911Tools.GetAllUserExtWithoutEnroll(var buffer: PSafeArray)
  : PSafeArray;
begin
...
function TZd2911Tools.GetASCII(var bs: PSafeArray; index: Integer;
  length: Integer): WideString;
begin
  Result := DefaultInterface.GetASCII(bs, index, length);
end;

function TZd2911Tools.GetStringByNum(var bs: PSafeArray; index: Integer;
  type_: NumberType): WideString;
begin
  Result := DefaultInterface.GetStringByNum(bs, index, type_);
end;

function TZd2911Tools.GetBytesByNum(const input: WideString; type_: NumberType)
  : PSafeArray;
begin
  Result := DefaultInterface.GetBytesByNum(input, type_);
end;

function TZd2911Tools.ConvertIPAddressToNumber(const strIPAddress
  : WideString): Integer;
begin
  Result := DefaultInterface.ConvertIPAddressToNumber(strIPAddress);
end;

function TZd2911Tools.ConvertNumberToIPAddress(intIPAddress: Integer)
  : WideString;
begin
  Result := DefaultInterface.ConvertNumberToIPAddress(intIPAddress);
end;

function TZd2911Tools.ConvertFingerprintToString(var Fingerprint: PSafeArray)
  : WideString;
begin
  Result := DefaultInterface.ConvertFingerprintToString(Fingerprint);
end;

function TZd2911Tools.ConvertStringFingerprintToBytes(const Fingerprint
  : WideString): PSafeArray;
begin
...
class function CoZd2911Listener.CreateRemote(const MachineName: string)
  : IZd2911Listener;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911Listener)
    as IZd2911Listener;
end;

procedure TZd2911Listener.InitServerData;
const
  CServerData: TServerData = (ClassID: '{F4DC2752-B340-4371-811F-5FFF33EF45F5}';
    IntfIID: '{433ABD46-80F4-4ABC-A80D-C365F93F1297}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TZd2911Listener.add_ReceiveHandlerExt(const value
  : _ReceiveHandlerExt);
begin
  DefaultInterface.add_ReceiveHandlerExt(value);
end;

procedure TZd2911Listener.remove_ReceiveHandlerExt
  (const value: _ReceiveHandlerExt);
begin
...
class function CoReceiveEventArgExt.CreateRemote(const MachineName: string)
  : IReceiveEventArgExt;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ReceiveEventArgExt)
    as IReceiveEventArgExt;
end;

procedure TReceiveEventArgExt.InitServerData;
const
  CServerData: TServerData = (ClassID: '{8C77333A-B46C-4258-87D7-EFD6025579E0}';
    IntfIID: '{7A3D809B-8D97-4411-9A91-504B806AF6EC}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{2985032F-FA75-428A-B840-3A74FBEA56BA}';
    IntfIID: '{F282EC34-C902-43B0-9CC7-EB7FC9807779}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
begin
  Result := CreateComObject(CLASS_Zd2911DeviceConnection)
    as IZd2911DeviceConnection;
end;

class function CoZd2911DeviceConnection.CreateRemote(const MachineName: string)
  : IZd2911DeviceConnection;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911DeviceConnection)
    as IZd2911DeviceConnection;
end;

procedure TZd2911DeviceConnection.InitServerData;
const
  CServerData: TServerData = (ClassID: '{8700A266-9300-43AA-8FCE-2A25EE51BAED}';
    IntfIID: '{AA9A9F67-97BB-49FD-A3BE-59D3635BDD10}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
function TZd2911DeviceConnection.GetServerProperties
  : TZd2911DeviceConnectionProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
function TZd2911DeviceConnection.SetPropertyExt(property_: UserProperty;
  ...
  var extraData: PSafeArray): WordBool;
begin
  Result := DefaultInterface.SetPropertyExt(property_, extraProperty, User,
    extraData);
end;

function TZd2911DeviceConnection.GetPropertyExt(property_: UserProperty;
  var extraProperty: PSafeArray; var User: IUserExt; var extraData: PSafeArray)
  : WordBool;
begin
  Result := DefaultInterface.GetPropertyExt(property_, extraProperty, User,
    extraData);
end;
...
function TZd2911DeviceConnection.SetPropertyExt_2(property_: DeviceProperty;
  ...
  var extraData: PSafeArray): WordBool;
begin
  Result := DefaultInterface.SetPropertyExt_2(property_, extraProperty, Device,
    extraData);
end;

function TZd2911DeviceConnection.GetPropertyExt_2(property_: DeviceProperty;
  var extraProperty: PSafeArray; var Device: IDevice; var extraData: PSafeArray)
  : WordBool;
begin
  Result := DefaultInterface.GetPropertyExt_2(property_, extraProperty, Device,
    extraData);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}

constructor TZd2911DeviceConnectionProperties.Create
  (AServer: TZd2911DeviceConnection);
begin
  inherited Create;
  FServer := AServer;
end;

function TZd2911DeviceConnectionProperties.GetDefaultInterface
  : IZd2911DeviceConnection;
begin
  Result := FServer.DefaultInterface;
end;
...
const
  CServerData: TServerData = (ClassID: '{FA689B01-3CD8-43D1-B005-98E0AC2E30BA}';
    IntfIID: '{1A8D64B8-5B67-4B26-92A7-E845A9F9D7D8}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{E28341BA-51C2-4C2B-8D27-9C63B1B70790}';
    IntfIID: '{13E5AFC5-D6D7-452A-879B-06F134E07D82}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{4425D88F-D4DE-4B4A-906E-5B6588615AED}';
    IntfIID: '{8D242E69-0A61-4C3B-9557-C8BEFEAC875A}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{CECA7182-F7F8-4AB3-81A3-EE4C3AFAE45D}';
    IntfIID: '{C929500D-BD1A-478A-9038-76EEA452C792}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{CA1503C4-2A83-4F99-941D-D22182555970}';
    IntfIID: '{C2FE27AA-AE68-486C-ACCB-2B43ED66169E}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{9FA413E1-00D0-3C70-86E1-F758E596C0C6}';
    IntfIID: '{87B84DB7-34CA-3800-8E2C-D0D74B36E7C1}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{D4D6189E-DC09-3B67-ABA4-340332789743}';
    IntfIID: '{8303232C-11FC-3D42-A7A2-1641CE2B609D}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
class function CoDeviceConnection.CreateRemote(const MachineName: string)
  : _DeviceConnection;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DeviceConnection)
    as _DeviceConnection;
end;
...
class function CoZdFpReader.CreateRemote(const MachineName: string)
  : _ZdFpReader;
begin
...
const
  CServerData: TServerData = (ClassID: '{8E97208C-51B9-35A1-BEEF-52B1483E5846}';
    IntfIID: '{17068156-9EBD-3018-9A85-5DA5EC50C26C}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
class function CoZd2911Utils.CreateRemote(const MachineName: string)
  : _Zd2911Utils;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911Utils)
    as _Zd2911Utils;
end;
...
class function CoZdCommBase.CreateRemote(const MachineName: string)
  : _ZdCommBase;
begin
...
const
  CServerData: TServerData = (ClassID: '{D55C3262-25FD-3128-830C-5A3FE007AD5F}';
    IntfIID: '{872E1A36-0C41-348D-B42F-EB08F2ADC6FD}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
const
  CServerData: TServerData = (ClassID: '{09A5CCAF-0725-389A-BA2D-F1CC3DFECB38}';
    IntfIID: '{BD8A5A36-F224-3092-AA45-BF4CB2D4FAD5}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
class function CoReceiveHandler.CreateRemote(const MachineName: string)
  : _ReceiveHandler;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ReceiveHandler)
    as _ReceiveHandler;
end;
...
class function CoZd2911Monitor.CreateRemote(const MachineName: string)
  : _Zd2911Monitor;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911Monitor)
    as _Zd2911Monitor;
end;
...
class function CoReceiveEventArg.CreateRemote(const MachineName: string)
  : _ReceiveEventArg;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ReceiveEventArg)
    as _ReceiveEventArg;
end;

procedure TReceiveEventArg.InitServerData;
const
  CServerData: TServerData = (ClassID: '{135D9304-05F5-3664-B412-50912A4ABFA2}';
    IntfIID: '{76CCC584-F45C-30CF-A7A2-FE85DEE0777D}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
class function CoReceiveHandlerExt.CreateRemote(const MachineName: string)
  : _ReceiveHandlerExt;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ReceiveHandlerExt)
    as _ReceiveHandlerExt;
end;
...
class function CoConnectionException.CreateRemote(const MachineName: string)
  : _ConnectionException;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ConnectionException)
    as _ConnectionException;
end;

procedure TConnectionException.InitServerData;
const
  CServerData: TServerData = (ClassID: '{0C3BF980-7BD7-3BBF-BDEA-4B7B087D9F46}';
    IntfIID: '{61DBAA57-0CE2-3801-8E78-A21669BD1547}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
function TConnectionException.GetServerProperties
  : TConnectionExceptionProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
constructor TConnectionExceptionProperties.Create
  (AServer: TConnectionException);
begin
  inherited Create;
  FServer := AServer;
end;

function TConnectionExceptionProperties.GetDefaultInterface
  : _ConnectionException;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  Result := CreateComObject(CLASS_Zd2911EnrollFileManagement)
    as _Zd2911EnrollFileManagement;
end;

class function CoZd2911EnrollFileManagement.CreateRemote(const MachineName
  : string): _Zd2911EnrollFileManagement;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Zd2911EnrollFileManagement)
    as _Zd2911EnrollFileManagement;
end;

procedure TZd2911EnrollFileManagement.InitServerData;
const
  CServerData: TServerData = (ClassID: '{1E9F786B-2C78-37C8-8FD2-0FA1D0298404}';
    IntfIID: '{787A0B63-5843-3E76-AEE9-A2B7D8F4314E}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TZd2911EnrollFileManagement.ConnectTo
  (svrIntf: _Zd2911EnrollFileManagement);
begin
  Disconnect;
  FIntf := svrIntf;
end;
...
function TZd2911EnrollFileManagement.GetDefaultInterface
  : _Zd2911EnrollFileManagement;
begin
  if FIntf = nil then
    Connect;
...
function TZd2911EnrollFileManagement.GetServerProperties
  : TZd2911EnrollFileManagementProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
constructor TZd2911EnrollFileManagementProperties.Create
  (AServer: TZd2911EnrollFileManagement);
begin
  inherited Create;
  FServer := AServer;
end;

function TZd2911EnrollFileManagementProperties.GetDefaultInterface
  : _Zd2911EnrollFileManagement;
begin
  Result := FServer.DefaultInterface;
end;
...
const
  CServerData: TServerData = (ClassID: '{83C6A271-3C80-3666-8AFB-ACC9F02D8C3D}';
    IntfIID: '{4A6C3A7B-A894-3295-A4D4-EF0FEAA82063}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TZd2911EnrollFile, TZd2911Tools,
    TZd2911Listener, TReceiveEventArgExt, TDevice, TZd2911DeviceConnection,
    TEnrollExt, TUserExt, TRecordExt, TMonitor, TSex, TUser, TEnroll,
    TZdFpReader, TRecord, TRLYN060, TReceiveEventArg, TConnectionException,
    TZd2911EnrollFileManagement, TP2pUtils]);
end;
